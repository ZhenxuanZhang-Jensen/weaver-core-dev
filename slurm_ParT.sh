...
# export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/hpcfs/cms/cmsgpu/zhangzhx/miniconda/envs/ML_env/lib/
# source /cvmfs/sft.cern.ch/lcg/views/dev4cuda/Tue/x86_64-centos7-gcc8-opt/setup.sh
...
--use-amp --batch-size 768 --start-lr 6.75e-3 --num-epochs 10 --optimizer ranger --fetch-step 0.008 \
...
# python XGBoost_training_bayes.py

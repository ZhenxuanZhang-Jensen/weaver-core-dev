...
--use-amp --batch-size 768 --start-lr 6.75e-3 --num-epochs 50 --optimizer ranger --fetch-step 0.01 \
...
"/cms/user/zhangzhx/GloParT_data/20230504_ak8_UL17_v8/Spin0ToTT_VariableMass_WhadOrlep_MX-600to6000_MH-15to250/*.root" \
--data-test \

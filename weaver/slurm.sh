...
# python test.py
sh /hpcfs/cms/cmsgpu/zhangzhx/weaver-core-dev/weaver/run_new_GloParT_nonMD_origin.sh > /hpcfs/cms/cmsgpu/zhangzhx/weaver-core-dev/weaver/output_train_nonMD_TOP_TOP_distributedGPU_origin.out 2>&1
